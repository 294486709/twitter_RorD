...
def main():
	xtrain = list(np.load('dataset/xxtrain.npy'))
	# xtrain = reshape(xtrain)
	ytrain = list(np.load('dataset/xytrain.npy'))
	xtest = list(np.load('dataset/xxtest.npy'))
	# xtest = reshape(xtest)
	ytest = list(np.load('dataset/xytest.npy'))
	xval = list(np.load('dataset/xxval.npy'))
	# xval = reshape(xval)
	yval = list(np.load('dataset/xyval.npy'))
